# -*- coding: utf-8 -*-
"""
Created on Thu May 14 17:07:58 2026
...
no_diff_h.to_csv('H:\\work\\Postdoctoral\\GWAS疾病位点检测\\results\\HiRPC\\one-dimensional_new\\signals\\all_reps\\stable_housekeeping_rescaled_bw\\LSS_OSS_stable_housekeeping_peaks.bed' , header = None , index = None , sep = '\t')
...
signal_file = "H:\\work\\Postdoctoral\\GWAS疾病位点检测\\results\\HiRPC\\one-dimensional_new\\signals\\all_reps\\stable_housekeeping_rescaled_bw\\stable_peaks_bw_signal.tab"
...
scale_factors.to_csv(
    "H:\\work\\Postdoctoral\\GWAS疾病位点检测\\results\\HiRPC\\one-dimensional_new\\signals\\all_reps\\stable_housekeeping_rescaled_bw\\LSS_OSS_stable_peaks_trimmedMean_scale_factors.txt",
    sep="\t",
    header=["scale_factor"]
)


####results: LSS_scales factor: 1.518

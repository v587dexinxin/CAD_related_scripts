...
data = pd.read_csv('H:\\work\\Postdoctoral\\GWAS疾病位点检测\\results\\CAD\\first_6000\\Genes associated with cardiovascular disease.csv' , header = 0)

data_new = data.values.flatten().tolist()
CVD_genes = pd.Series(data_new).dropna().tolist()

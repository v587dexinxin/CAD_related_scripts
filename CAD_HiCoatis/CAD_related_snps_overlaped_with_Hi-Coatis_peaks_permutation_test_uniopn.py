# -*- coding: utf-8 -*-
"""
Created on Mon Jun 15 17:48:57 2026
...
cad_snp_bed = "/scratch/2026-06-15/bio-shenw/Cardiovascular_disease_STARR-seq/CAD_SNPs/Hapmap/CAD_related_SNPs_LD0.8_all_+-200bp.bed"
background_snp_bed = "/scratch/2026-06-15/bio-shenw/Cardiovascular_disease_STARR-seq/CAD_SNPs/Hapmap/noCAD_related_SNPs_LD0.8_all_background_+-200bp.bed"
peak_bed = "/scratch/2026-06-15/bio-shenw/Cardiovascular_disease_STARR-seq/HUVEC_Cardiovascular_disease_moudle/HiRPC/one-dimension_new/mapping_new/macs2/union_peaks/union_peaks_sorted_merged_clean.bed"
overlaped_bed ="/scratch/2026-06-15/bio-shenw/Cardiovascular_disease_STARR-seq/CAD_SNPs/CAD_SNPs_VS_union_Hi-Coatis_peaks/CAD_SNPs_LD0.8_VS_union_Hi-Coatis_peaks_snp_+-200bp.bed"

outdir = "/scratch/2026-06-15/bio-shenw/Cardiovascular_disease_STARR-seq/CAD_SNPs/CAD_SNPs_VS_union_Hi-Coatis_peaks/CAD_SNP_chr_matched_random_enrichment_2"
os.makedirs(outdir, exist_ok=True)

n_random = 1000
observed_overlap_count = len(pd.read_table(overlaped_bed , header = None))
...
random_df = pd.read_table('H:\\work\\Postdoctoral\\GWAS疾病位点检测\\results\\CAD\\CAD_SNPs_VS_union_Hi-Coatis_peaks\\CAD_SNP_chr_matched_random_enrichment_2\\chr_matched_random_overlap_results.tsv' , header = 0)

result = pd.read_table('H:\\work\\Postdoctoral\\GWAS疾病位点检测\\results\\CAD\\CAD_SNPs_VS_union_Hi-Coatis_peaks\\CAD_SNP_chr_matched_random_enrichment_2\\chr_matched_random_enrichment_summary.tsv' , header = 0)

outdir = 'H:/work/Postdoctoral/GWAS疾病位点检测/results/CAD/CAD_SNPs_VS_union_Hi-Coatis_peaks/CAD_SNP_chr_matched_random_enrichment_2'

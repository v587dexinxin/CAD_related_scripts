# -*- coding: utf-8 -*-
"""
Created on Thu May 28 15:51:59 2026
...
peak_bed = "/scratch/2026-05-25/bio-shenw/Cardiovascular_disease_STARR-seq/HUVEC_Cardiovascular_disease_moudle/HiRPC/one-dimension_new/mapping_new/DiffBind/Diffbind_DEseq2/HUVEC_LS_VS_OS_DESeq2_OSS_specific_peaks_q0.05_fc0.5_clean.bed"
overlaped_bed ="/scratch/2026-05-25/bio-shenw/Cardiovascular_disease_STARR-seq/CAD_SNPs/CAD_SNPs_VS_OSS_speci_Hi-Coatis_peaks/CAD_SNPs_LD0.8_VS_OSS_speci_Hi-Coatis_peaks_snp_+-200bp.bed"


outdir = "/scratch/2026-05-25/bio-shenw/Cardiovascular_disease_STARR-seq/CAD_SNPs/CAD_SNPs_VS_OSS_speci_Hi-Coatis_peaks/CAD_SNP_chr_matched_random_enrichment_2"
...
random_df = pd.read_table('H:\\work\\Postdoctoral\\GWAS疾病位点检测\\results\\CAD\\CAD_SNPs_VS_OSS_speci_Hi-Coatis_peaks\\CAD_SNP_chr_matched_random_enrichment_2\\chr_matched_random_overlap_results.tsv' , header = 0)

result = pd.read_table('H:\\work\\Postdoctoral\\GWAS疾病位点检测\\results\\CAD\\CAD_SNPs_VS_OSS_speci_Hi-Coatis_peaks\\CAD_SNP_chr_matched_random_enrichment_2\\chr_matched_random_enrichment_summary.tsv' , header = 0)

outdir = 'H:/work/Postdoctoral/GWAS疾病位点检测/results/CAD/CAD_SNPs_VS_OSS_speci_Hi-Coatis_peaks/CAD_SNP_chr_matched_random_enrichment_2'

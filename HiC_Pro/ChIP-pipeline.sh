...
outdir=/scratch/2023-11-06/bio-shenw/Ljniu/K562/K562_H/one-dimensional/mapping
rawdata_dir=/scratch/2023-11-06/bio-shenw/Ljniu/K562/K562_H/one-dimensional/data
genome_bowtie2_index=/scratch/2023-11-06/bio-shenw/ref/Human/hg38/bowtie2_index_bylxx/hg38.fa

cd $outdir
for sample in ${rawdata_dir}/*_R1.fastq;do
	sample=$(basename $sample _R1.fastq)
	R1=$rawdata_dir/${sample}_R1.fastq
	R2=$rawdata_dir/${sample}_R2.fastq

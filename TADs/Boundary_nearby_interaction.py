...
# Tad = np.loadtxt('/scratch/2026-07-06/bio-shenw/Cardiovascular_disease_STARR-seq/HUVEC_Cardiovascular_disease_moudle/HiRPC/merged_all_reps/h5/TADs/res_10K/HUVEC_WT_merged_hg38_balanced_10K_boundaries.bed' , dtype = boundary_type , usecols= (0 , 1))
...
Matrix = {}
for c in cells:
    pp = PdfPages('/scratch/2026-07-06/bio-shenw/Cardiovascular_disease_STARR-seq/HUVEC_Cardiovascular_disease_moudle/HiRPC/plots/Boundary_nearby_interaction/' + c + '_Boundary_nearby_interaction_40K_ave.pdf')
    HiC_Lib = HiC_Data[c]
    Tad_Lib = Tad
    ...
    for i in Tad_Lib:
        ...
        if (startHiC < 0) or (endHiC > len(HiC_lib)):
            continue

# -*- coding: utf-8 -*-
"""
Created on Mon May 18 16:36:40 2026
...
no_diff = pd.read_csv('H:\\work\\Postdoctoral\\GWAS疾病位点检测\\results\\HiRPC\\ATAC-seq\\DiffBind\\DiffBind_DEseq2\\HUVEC_LS_VS_OS_ATAC_DESeq2_common_peaks_p0.05_fc0.5.csv' , header=0)
...
no_diff_h.to_csv('H:\\work\\Postdoctoral\\GWAS疾病位点检测\\results\\HiRPC\\ATAC-seq\\signals\\LSS_OSS_ATAC_stable_housekeeping_peaks.bed' , header = None , index = None , sep = '\t')
...
signal_file = "H:\\work\\Postdoctoral\\GWAS疾病位点检测\\results\\HiRPC\\ATAC-seq\\signals\\stable_housekeeping_rescaled_bw\\LS_OS_ATAC_stable_peaks_bw_signal.tab"
...
scale_factors.to_csv(
    "H:\\work\\Postdoctoral\\GWAS疾病位点检测\\results\\HiRPC\\ATAC-seq\\signals\\stable_housekeeping_rescaled_bw\\LSS_OSS_stable_peaks_trimmedMean_scale_factors.txt",
    sep="\t",
    header=["scale_factor"]
)


####results: LSS_scales factor: 1.712

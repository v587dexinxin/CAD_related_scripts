...
for c in cells:
    ...
    #####Out_Files#####
    OutFolder = '/scratch/2026-07-06/bio-shenw/Cardiovascular_disease_STARR-seq/HUVEC_Cardiovascular_disease_moudle/HiRPC/plots/selected_heatmap_plots_' + gene_name
    ...
    interval = [(g , 0 , 242193529)]
    interval_1 = [(g , 121000000 , 151000000)]

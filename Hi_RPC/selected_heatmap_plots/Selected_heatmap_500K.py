# -*- coding: utf-8 -*-
"""
Created on Thu May 21 16:31:52 2026
...
f_wt = "/scratch/2026-05-18/bio-shenw/Cardiovascular_disease_STARR-seq/HUVEC_Cardiovascular_disease_moudle/HiRPC/merged_all_reps/cool/HUVEC_WT_merged.hg38.nodups.mapq_30.1000.mcool"
f_ls = "/scratch/2026-05-18/bio-shenw/Cardiovascular_disease_STARR-seq/HUVEC_Cardiovascular_disease_moudle/HiRPC/merged_all_reps/cool/HUVEC_LS_merged.hg38.nodups.mapq_30.1000.mcool"
f_os = "/scratch/2026-05-18/bio-shenw/Cardiovascular_disease_STARR-seq/HUVEC_Cardiovascular_disease_moudle/HiRPC/merged_all_reps/cool/HUVEC_OS_merged.hg38.nodups.mapq_30.1000.mcool"

g = 'chr15'
R = 500000

wt_matrix = Get_matrix(f_wt, g, '500000')
ls_matrix = Get_matrix(f_ls, g, '500000')
os_matrix = Get_matrix(f_os, g, '500000')
...
for c in cells:
    ...
    #####Out_Files#####
    OutFolder = '/scratch/2026-05-18/bio-shenw/Cardiovascular_disease_STARR-seq/HUVEC_Cardiovascular_disease_moudle/HiRPC/plots/selected_heatmap_plots'
    OutFil = 'HUVEC_' + c + '_heatmap_' + g + '_' + str(R // 1000) + 'K.pdf'
    pp = PdfPages(os.path.join(OutFolder , OutFil))
    
    
    ####interval#####
    
    interval = [('chr15' , 18000000 , 102000000)]
    interval_1 = [('chr15' , 34000000 , 65000000)]
